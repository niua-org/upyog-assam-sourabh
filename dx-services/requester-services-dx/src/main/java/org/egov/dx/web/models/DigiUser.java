...
import org.egov.dx.web.models.BloodGroup;
import org.egov.dx.web.models.Gender;
import org.egov.dx.web.models.GuardianRelation;
import org.egov.dx.web.models.UserType;
...
public class DigiUser {
    ...
    public DigiUser addAddressItem(Address addressItem) {
    ...
    public DigiUser addRolesItem(Role roleItem) {
        if (this.roles == null) {
...
//    }
    ...
    public DigiUser toUser(DigiUser u) {
